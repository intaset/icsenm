<?php
$my_email = "registration@icsenm.com";
$errors = array();
...
Thank you for registering for ICSENM 2016. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@icsenm.com. You can find the copyright form here: www.icsenm.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
$your_subject = "Your Registration Details for ICSENM'16";

$your_headers = "From: ICSENM'16 <" . $my_email . ">";
...
<title>ICSENM'16 - Registration Form Filled!</title>
...
<div id="content">
  ...
  <header>
	...
	<div class="cbp-af-inner">
        ...
        <div class="bg">
          <h1>International conference on Structural<br>Engineering, New Technology and Methods (ICSENM'16)</h1>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICSENM 2016:</p>
      <p class="body">ICSENM 2016 will  be held in Ottawa, Canada on March 30 - 31, 2016.</p>
    </div>          
    <div>
      <h2 class="title">2</h2>
  ...
  <div class="unit-spacer content">
    ...
    <p class="body">If you do not receive an email, <strong>please check your SPAM folder</strong>.</p>
 	...
 	<p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
  	...
  	<p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@icsenm.com" class="body-link">registration@icsenm.com</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

	<p class="body">We are looking forward to seeing you at ICSENM'16!</p>
  </div>
</div>
...
<footer id="contact">
	...
	<div class="unit-spacer">
		...
		+1-613-695-3040<br>
		<a href="mailto:info@icsenm.com">info@icsenm.com</a></p>
		</div>
	</div>

	<div class="unit unit-s-1 unit-m-2-3 unit-l-2-3 contact">
	<div class="unit-spacer">
	<p class="body">For questions or comments regarding ICSENM'16, please fill out the form below:</p>
